...
export default function Home() {
    ...
    const loadData = async () => {
        let response = await fetch("plate-pal-99tg-fgqu257v7-ishanbh7.vercel.app/api/foodData", {
            method: "POST",
            headers: {
            ...
            <div><div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel" style={{ objectFit: "contain !important" }}>
                <div className="carousel-inner" id='carausal'>
                    <div className="carousel-caption" style={{ zIndex: "10" }}>
                        <div className="carimg d-flex justify-content-center">
